...
var hp:=values.knight_hp
var dmg:=values.knight_dmg
var moves_d:=values.knight_moves
var moves_c:=0
var range:=1
var pop:=values.knight_pop
var armor_d:=values.knight_armor
var armor_c:=values.knight_armor
var cost:=[values.knight_cost_food,values.knight_cost_wood,values.knight_cost_metal]
var needs_level:=values.knight_level
var max:=15
var owner_id:=0
var pos:=Vector2(0,0)
