...
var hp:=values.cannon_hp
var dmg:=values.cannon_dmg
var moves_d:=values.cannon_moves
var moves_c:=0
var range:=values.cannon_range
var pop:=values.cannon_pop
var armor_d:=values.cannon_armor
var armor_c:=values.cannon_armor
var cost:=[values.cannon_cost_food,values.cannon_cost_wood,values.cannon_cost_metal]
var needs_level:=values.cannon_level
var max:=15
var owner_id:=0
var pos:=Vector2(0,0)
